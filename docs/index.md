---
layout: home
title: Infinite Quest Nexus documentation
titleTemplate: false

hero:
  name: Infinite Quest Nexus
  text: Persistent worlds. Durable campaigns.
...
features:
  - title: Infinite Quest
    details: The player experience for running and continuing AI-assisted stories.
  - title: World Library
    details: Create, publish, fork, archive, import, and export reusable versioned worlds.
  - title: Campaigns and Chronicle
    details: Preserve accepted turns, authoritative campaign state, summaries, and searchable long-term memory.
  - title: Story Engine
