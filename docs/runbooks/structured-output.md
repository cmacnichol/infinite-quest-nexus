...
```powershell
corepack pnpm probe:structured-output -- --model deepseek/deepseek-v3.2-exp --route novita/fp8 --input-usd-per-token 0.00000027 --output-usd-per-token 0.00000041 --price-observed-at 2026-09-20T23:44:13.000Z --context-tokens 163840 --max-calls 18 --max-output-tokens 2048
```
