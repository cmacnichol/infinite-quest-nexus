...
For a campaign with no accepted turns, Infinite Quest displays **Background Story** when the world provides one, then queues the world's opening action. There is no separate Begin button.
