...
| 01 actual vs configured model/prompt cohorts | Cohort output fixtures and source trace | Passed at 9f5986ca; see phase-01 handoff and coordinator rerun |
...
| 02 mandatory rule in actual composed requests | Default/override/Action/Story Direction payload tests | Pending |
| 02 old prompt identity preserved | Old job retry/resume and new enqueue integration evidence | Pending |
