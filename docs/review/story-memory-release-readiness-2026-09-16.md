...
- **Known baseline failures:** source-authoring and source-authoring-security have the same four failures against an immutable archive of the original HEAD. Those unrelated failures remain.
