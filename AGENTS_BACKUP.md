...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-31 (commit ffd2e0d). Confidence: 100%.
...
- `apps/web-next/src/story-player-page.ts` — 15 bug fixes, last fix 11 days ago (bug magnet); 28 commits/90d
- `tests/unit/web-next-story-page.test.ts` — 13 bug fixes, last fix 11 days ago (bug magnet); 24 commits/90d
- `services/api/src/server.ts` — 13 bug fixes, last fix 11 days ago (bug magnet); 15 commits/90d
- `tests/integration/generation.integration.test.ts` — 12 bug fixes, last fix 3 weeks ago (bug magnet); 13 commits/90d
- `tests/unit/story-player-ui.test.ts` — 11 bug fixes, last fix today (bug magnet); 21 commits/90d

### Code health
Three co-equal signals: defect risk 5.77/10 avg, hotspot health 4.23/10 (stable), worst `apps/web-next/src/story-player-page.ts` at 1.0/10 · maintainability 7.66/10 · performance risk 187 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `tests/integration/campaign-authority-repository.integration.test.ts` — change entropy — impact −3.0
- `scripts/lib/chronicle-retrieval-evaluator.ts` — change entropy — impact −2.6
- `tests/unit/chronicle-retrieval-evaluator.test.ts` — change entropy — impact −2.6
- `packages/database/src/chronicle-chunk-repository.ts` — complex conditional (validateProgress) — impact −2.5
- `packages/database/src/system-archive-private-storage-repository.ts` — complex conditional (validateLeaseInput) — impact −2.5
