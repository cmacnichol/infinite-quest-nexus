...
try {
  await lifecycle.initialize(async (fixture, isRunning) => {
    ...
    if (!isRunning()) return;
    await writeFile(statePath, `${JSON.stringify({ baseUrl: fixture.baseUrl, campaignId: fixture.campaignId, emptyStoryCampaignId: fixture.emptyStoryCampaignId, emptyStoryCampaignMobileId: fixture.emptyStoryCampaignMobileId, emptyNewUiStoryCampaignId: fixture.emptyNewUiStoryCampaignId, emptyNewUiStoryCampaignMobileId: fixture.emptyNewUiStoryCampaignMobileId, actionOnlyCampaignId: fixture.actionOnlyCampaignId, databaseName: fixture.databaseName, renderer: fixture.renderer })}\n`, "utf8");
