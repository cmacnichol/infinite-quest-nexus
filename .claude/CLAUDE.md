...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-06 (commit 6c8e0ab). Confidence: 100%.
...
- `apps/web-next/src/story-player-page.ts` — 15 bug fixes, last fix 2 weeks ago (bug magnet); 28 commits/90d
- `tests/unit/web-next-story-page.test.ts` — 13 bug fixes, last fix 2 weeks ago (bug magnet); 24 commits/90d
- `services/api/src/server.ts` — 13 bug fixes, last fix 2 weeks ago (bug magnet); 15 commits/90d
- `tests/integration/generation.integration.test.ts` — 12 bug fixes, last fix 4 weeks ago (bug magnet); 13 commits/90d
- `tests/unit/story-player-ui.test.ts` — 11 bug fixes, last fix 5 days ago (bug magnet); 21 commits/90d

### Code health
Three co-equal signals: defect risk 5.89/10 avg, hotspot health 4.28/10 (stable), worst `apps/web-next/src/story-player-page.ts` at 1.0/10 · maintainability 7.71/10 · performance risk 188 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `apps/web-next/src/bootstrap.ts` — nested complexity (start) — impact −2.5
