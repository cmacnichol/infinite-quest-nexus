...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-10 (commit e8d00d8). Confidence: 100%.
...
- `tests/integration/image-pipeline.integration.test.ts` — 11 bug fixes, last fix 2 days ago (bug magnet); 27 commits/90d
- `tests/integration/generation.integration.test.ts` — 11 bug fixes, last fix 4 days ago (bug magnet); 34 commits/90d
- `services/api/src/server.ts` — 11 bug fixes, last fix 4 days ago (bug magnet); 30 commits/90d
- `tests/integration/campaign-archive.integration.test.ts` — 8 bug fixes, last fix 4 days ago (bug magnet); 25 commits/90d

### Code health
Three co-equal signals: defect risk 6.11/10 avg, hotspot health 4.41/10 (stable), worst `apps/web/public/nexus.js` at 1.0/10 · maintainability 7.76/10 · performance risk 141 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
