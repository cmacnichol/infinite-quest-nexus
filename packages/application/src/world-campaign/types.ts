...
export type GeneratedWorldPreviewView = Readonly<{ title: string; content: DeepReadonly<WorldContent>; physicalAccounting?: DeepReadonly<import("@infinite-quest/contracts").PhysicalTextAccounting> }>;
