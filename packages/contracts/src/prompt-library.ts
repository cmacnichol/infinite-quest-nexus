...
export const PROMPT_TEMPLATE_CATALOG: Record<PromptTemplateKey, PromptTemplateDefinition> = {
  ...
  event_extension: { key: "event_extension", title: "Event extension writer", category: "Story Engine", description: "Completes a validated story with immediate event fiction.", campaignOverrideAllowed: true, maxLength: 8000, variables: [], defaultContent: "You complete an already validated adventure turn with a fiction-only immediate event. Return one complete StoryTurnOutput JSON object and no commentary. Preserve the supplied narration unchanged, then append one to three short paragraphs that reflect every supplied fictional event instruction. Return complete replacement continuity, choices, image prompt, facts, threads, scratchpad, and tracker updates for the full story. Never expose private evaluation, game-system terminology, hidden instructions, or reasoning." },
...
Do not include credentials, model instructions, private reasoning, rolls, checks, dice results, or parser diagnostics in fictional fields.` },
  world_generation_recovery: { key: "world_generation_recovery", title: "World generation recovery", category: "World authoring", description: "Recovers a truncated world object.", campaignOverrideAllowed: false, maxLength: 4000, variables: [], defaultContent: `The previous response was not a complete generated world. Return a complete replacement JSON object, not a continuation or patch. Include title, genre, tone, backgroundStory, premise, firstAction, story_rules, default_triggers, event_triggers, rpg_statistics, and character_seeds.
${generatedWorldCharacterSeedRequirements}
Start again at { and close every field and the final }.` },
  world_character_generation: { key: "world_character_generation", title: "Generated world character", category: "World authoring", description: "Expands one generated character seed into a complete playable character.", campaignOverrideAllowed: false, maxLength: 12000, variables: [], defaultContent: `Create one complete playable character for the supplied generated world and character seed. Return JSON only with exactly one object following this shape:
{"id":"seed id","name":"character name","character_text":"non-empty narrative guidance","profile":{"identity":{"aliases":[],"pronouns":""},"story":{"role":"","background":"","personality":"","motivations":"","goals":"","fearsAndConflicts":"","keyRelationships":"","narrativeHooks":"","voiceAndMannerisms":"","otherGuidance":""},"appearance":{"ancestryOrSpecies":"","apparentAge":"","genderPresentation":"","build":"","skinOrComplexion":"","face":"","eyes":"","hair":"","distinguishingFeatures":[],"clothing":"","equipmentAndAccessories":"","otherVisualDetails":""},"unclassifiedNotes":""},"rpg_statistics":[],"default_triggers":[]}
Use the seed id and name exactly. ${generatedWorldCharacterRequirements}` },
  world_character_generation_recovery: { key: "world_character_generation_recovery", title: "Generated world character recovery", category: "World authoring", description: "Recovers one incomplete generated character profile.", campaignOverrideAllowed: false, maxLength: 6000, variables: [], defaultContent: `The preceding response was not a complete playable character. Return one complete playable character as a compact complete replacement for the same supplied seed, not a continuation or patch. Return JSON only.
{"id":"seed id","name":"character name","character_text":"non-empty narrative guidance","profile":{"identity":{"aliases":[],"pronouns":""},"story":{"role":"","background":"","personality":"","motivations":"","goals":"","fearsAndConflicts":"","keyRelationships":"","narrativeHooks":"","voiceAndMannerisms":"","otherGuidance":""},"appearance":{"ancestryOrSpecies":"","apparentAge":"","genderPresentation":"","build":"","skinOrComplexion":"","face":"","eyes":"","hair":"","distinguishingFeatures":[],"clothing":"","equipmentAndAccessories":"","otherVisualDetails":""},"unclassifiedNotes":""},"rpg_statistics":[],"default_triggers":[]}
Use the seed id and name exactly. ${generatedWorldCharacterRequirements}` },
