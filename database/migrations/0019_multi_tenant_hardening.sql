...
ALTER TABLE imports
  ...
  FOREIGN KEY (world_id, owner_user_id) REFERENCES worlds(id, owner_user_id) ON DELETE SET NULL,
  DROP CONSTRAINT IF EXISTS imports_world_version_id_fkey,
  ADD CONSTRAINT imports_world_version_owner_fk
  FOREIGN KEY (world_version_id, owner_user_id) REFERENCES world_versions(id, owner_user_id) ON DELETE SET NULL,
  DROP CONSTRAINT IF EXISTS imports_campaign_id_fkey,
  ADD CONSTRAINT imports_campaign_owner_fk
  FOREIGN KEY (campaign_id, owner_user_id) REFERENCES campaigns(id, owner_user_id) ON DELETE SET NULL;
...
ALTER TABLE assets
  ...
  FOREIGN KEY (turn_id, campaign_id, owner_user_id) REFERENCES turns(id, campaign_id, owner_user_id) ON DELETE SET NULL;
...
ALTER TABLE generation_jobs
  ...
  FOREIGN KEY (result_turn_id, campaign_id, owner_user_id) REFERENCES turns(id, campaign_id, owner_user_id) ON DELETE SET NULL;
