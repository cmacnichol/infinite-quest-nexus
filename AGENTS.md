...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-29 (commit 58d0aa2). Confidence: 100%.
...
- `tests/unit/management-ui.test.ts` — 7 bug fixes, last fix 2 days ago (bug magnet); 35 commits/90d
- `services/api/src/generation-service.ts` — 6 bug fixes, last fix yesterday (bug magnet); 32 commits/90d
- `apps/web/public/nexus.js` — 6 bug fixes, last fix 2 days ago (bug magnet); 38 commits/90d
- `tests/integration/image-pipeline.integration.test.ts` — 5 bug fixes, last fix yesterday (bug magnet); 21 commits/90d
- `tests/integration/campaign-archive.integration.test.ts` — 5 bug fixes, last fix today (bug magnet); 19 commits/90d

### Code health
Three co-equal signals: defect risk 5.86/10 avg, hotspot health 3.98/10 (stable), worst `apps/web/public/nexus.js` at 1.0/10 · maintainability 7.52/10 · performance risk 64 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
