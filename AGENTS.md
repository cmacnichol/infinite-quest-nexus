...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-26 (commit 9e1820a). Confidence: 100%.
...
- `services/api/src/server.ts` — 2 bug fixes, last fix 4 days ago; 33 commits/90d
- `tests/unit/server-security.test.ts` — 2 bug fixes, last fix 4 days ago; 9 commits/90d
- `apps/web/public/nexus.js` — 1 bug fix, last fix yesterday; 30 commits/90d
- `services/api/src/import-service.ts` — 1 bug fix, last fix yesterday; 15 commits/90d

### Code health
Three co-equal signals: defect risk 5.32/10 avg, hotspot health 2.84/10 (stable), worst `apps/web/public/nexus.js` at 1.0/10 · maintainability 7.19/10 · performance risk 44 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `packages/story-engine/src/providers/illustration/sogni/index.ts` — nested complexity (normalizeHttpError) — impact −2.4
- `README.md` — untested hotspot — impact −2.0
- `packages/contracts/src/imports.ts` — untested hotspot — impact −2.0
- `packages/database/src/config.ts` — untested hotspot — impact −2.0
