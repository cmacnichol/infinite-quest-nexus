...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-26 (commit 3ae1930). Confidence: 100%.
...
- `services/api/src/world-service.ts` — 2 bug fixes, last fix yesterday; 19 commits/90d
- `services/api/src/server.ts` — 2 bug fixes, last fix 4 days ago; 31 commits/90d
- `apps/web/public/nexus.js` — 1 bug fix, last fix yesterday; 29 commits/90d
- `services/api/src/import-service.ts` — 1 bug fix, last fix yesterday; 15 commits/90d
- `tests/unit/management-ui.test.ts` — 1 bug fix, last fix yesterday; 25 commits/90d

### Code health
Three co-equal signals: defect risk 4.89/10 avg, hotspot health 2.55/10 (stable), worst `services/api/src/asset-service.ts` at 1.0/10 · maintainability 6.87/10 · performance risk 34 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `packages/domain/src/world-characters.ts` — untested hotspot — impact −2.0
- `services/api/src/asset-service.ts` — untested hotspot — impact −2.0
- `services/api/src/generation-service.ts` — untested hotspot — impact −2.0
- `services/api/src/image-service.ts` — untested hotspot — impact −2.0
- `services/api/src/import-service.ts` — untested hotspot — impact −2.0
